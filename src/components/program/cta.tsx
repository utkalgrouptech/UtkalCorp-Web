      ...
      <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl p-8 md:p-12">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Partner with Utkal Corporation for Sustainable Metal Recycling and Trading Solutions
          </h2>
          <p className="text-white text-lg mb-8">
            Whether you are looking to recycle metal waste or source high-quality recycled metals, our team is ready to
            assist you.
          </p>
