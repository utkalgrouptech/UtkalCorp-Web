      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="100">
            Have questions or want to discuss your metal recycling needs? Reach out to our team.
          </p>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8" data-aos="fade-right">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <Textarea id="message" placeholder="Your message..." rows={5} className="w-full resize-none" />
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">123 Recycling Way, Green City, State 12345, USA</p>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">info@metalcyclepro.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <Clock className="h-6 w-6 text-white mr-4 mt-1" />
                  <div>
